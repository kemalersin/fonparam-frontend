        ...
        <div className="space-y-6">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-8 text-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <Link
                        to="/funds"
                        className="flex items-center justify-center p-6 bg-indigo-50 dark:bg-gray-700/50 rounded-lg hover:bg-indigo-100 dark:hover:bg-gray-700 transition-colors"
                    >
